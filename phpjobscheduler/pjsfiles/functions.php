  ...
  foreach ($rows AS $row)
  {
        ...
        $table_rows.="
           ...
           <div id=\"pjs$id\">
             ...
             href=pjslogo.gif>MODIFY</a> -
             <a href=pjslogo.gif>DELETE?</a> $run_only_once_txt<br>
...
function show_logs($qstart)
{
 ...
 if(count($rows))
 {
  ...
  foreach ($rows AS $row)
  {
   ...
   if ($bg_colour=="#E9E9E9") $bg_colour="#FFFFFF"; else $bg_colour="#E9E9E9";
   if ($output!="") $show_hide="<a href=pjslogo.gif>Show/Hide</a>";
  ...
  $next_link="<strong><a href=pjslogo.gif>Show Next $num logs &gt;&gt;</a>
             </strong><br><br><br>";
