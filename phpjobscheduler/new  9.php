<?php @session_start();?>
<?php require_once('../asset_management_system.php'); ?>
<?php
...
<div id="header">
		 ...
		 <li><a href="../adminloginmainpage.php">Home</a></li>
		  <li><a>About Us</a>
            ...
            <li><a href="file:///C|/wamp/www/contact_us.php">Contact Us</a></li>
...
<?php
 ...
 <table border="1" width="945" cellspacing="2" cellpadding="2" class=".searchtable">
<tr>
<td>
...
<td width="200">
<font face="Arial, Helvetica, sans-serif" ><b>Image</b></font>
</td>
...
<td>
<font face="Arial, Helvetica, sans-serif"><img src="<?php echo $image; ?>"width="200" height="125" alt="item" /></font>
</td>
...
<p>    
        ...
        <h1> Item Details </h1>
        <table border="1" cellpadding="1" cellspacing="1" width="945">
          ...
          <tr>
            ...
            <td width="110" align="center"><b>Item Status</b></td>
                        ...
                        <td width="200" height= "29" align="center"><b>Image Attachment</b></td>
          </tr>
          <?php do { ?>
          <tr>
            ...
            <td><?php echo $row_item_details['item_status']; ?></td>
                       ...
                       <td><img src="<?php echo $row_item_details['image_attachment']; ?>" width="200" height="125" alt="item" /></td>
          </tr>
...
<!--  #rmenu -->
 <ul id="rmenu" name="rmenu">
        ...
        <li><a href="header.html">Update Account</a></li>
