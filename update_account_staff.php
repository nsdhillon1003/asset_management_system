...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE staff SET staff_password=%s, staff_name=%s, staff_faculty=%s, staff_email=%s, staff_phone=%s WHERE staff_id=%s",
  ...
  $updateGoTo = "updated_staff_account.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_update_user = "-1";
if (isset($_GET['staff_id'])) {
  $colname_update_user = $_GET['staff_id'];
}
mysql_select_db($database_asset_management_system, $asset_management_system);
$query_update_user = sprintf("SELECT * FROM staff WHERE staff_id = %s", GetSQLValueString($colname_update_user, "text"));
$update_user = mysql_query($query_update_user, $asset_management_system) or die(mysql_error());
$row_update_user = mysql_fetch_assoc($update_user);
$totalRows_update_user = "-1";
if (isset($_SESSION['MM_Username'])) {
  $totalRows_update_user = $_SESSION['MM_Username'];
}

$colname_update_user = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_update_user = $_SESSION['MM_Username'];
}
mysql_select_db($database_asset_management_system, $asset_management_system);
$query_update_user = sprintf("SELECT * FROM staff WHERE staff_id = %s", GetSQLValueString($colname_update_user, "text"));
$update_user = mysql_query($query_update_user, $asset_management_system) or die(mysql_error());
...
<style type="text/css">
.rsub-menu1 {	list-style-type: none;
	position: absolute;
	left: 1017px;
	top: 113px;
	width: 147px;
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" class="table">
  <p>* Please contact an Administrator to change staff ID or access privilages.</p>
  <table width="676" align="left">
    <tr valign="baseline">
      <td width="138" align="left" nowrap="nowrap"><strong>Staff Id</strong></td>
      <td width="526"> <b>:</b> <?php echo $row_update_user['staff_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="left"><strong>Staff Password</strong></td>
      <td><span id="sprytextfield5"> <b>:</b> 
          <input type="password" name="staff_password" value="<?php echo htmlentities($row_update_user['staff_password'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield4">
         <b>:</b> 
        <input type="text" name="staff_name" value="<?php echo htmlentities($row_update_user['staff_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
        <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield3">
       <b>:</b>  
      <input type="text" name="staff_faculty" value="<?php echo htmlentities($row_update_user['staff_faculty'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
    </tr>
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield2">
       <b>:</b>  
      <input type="text" name="staff_email" value="<?php echo htmlentities($row_update_user['staff_email'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td><span id="sprytextfield1">
       <b>:</b> 
      <input type="text" name="staff_phone" value="<?php echo htmlentities($row_update_user['staff_phone'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
      <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="staff_id" value="<?php echo $row_update_user['staff_id']; ?>" />
  <input type="hidden" name="staff_type" value="<?php echo $row_update_user['staff_type']; ?>" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
</form>
...
<ul id="rmenu" name="rmenu">
  ...
  <li><a>Item</a>
    <ul class="rsub-menu">
      <li><a href="s_equipment_details.php">Item Details</a></li>
    </ul>
  </li>
