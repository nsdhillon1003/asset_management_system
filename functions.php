...
// ---------------------------------
include_once("phpjobscheduler/pjsfiles/config.inc.php");
include_once("phpjobscheduler/pjsfiles/constants.inc.php");
  ...
  foreach ($rows AS $row)
  {
        ...
        $table_rows.="
           ...
           <div id=\"pjs$id\">
             ...
             href=phpjobscheduler/pjsfiles/pjslogo.gif>MODIFY</a> -
             <a href=phpjobscheduler/pjsfiles/pjslogo.gif>DELETE?</a> $run_only_once_txt<br>
...
function show_logs($qstart)
{
 ...
 if(count($rows))
 {
  ...
  foreach ($rows AS $row)
  {
   ...
   if ($bg_colour=="#E9E9E9") $bg_colour="#FFFFFF"; else $bg_colour="#E9E9E9";
   if ($output!="") $show_hide="<a href=phpjobscheduler/pjsfiles/pjslogo.gif>Show/Hide</a>";
