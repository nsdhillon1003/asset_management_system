...
$colname_staff_details = "-1";
if (isset($_GET['staff_id'])) {
  $colname_staff_details = $_GET['staff_id'];
}
mysql_select_db($database_asset_management_system, $asset_management_system);
$query_staff_details = sprintf("SELECT * FROM staff WHERE staff_id = %s", GetSQLValueString($colname_staff_details, "text"));
$staff_details = mysql_query($query_staff_details, $asset_management_system) or die(mysql_error());
$row_staff_details = mysql_fetch_assoc($staff_details);
$totalRows_staff_details = mysql_num_rows($staff_details);
?>
  ...
  <div style="clear: both; alignment-adjust: hanging;">
    <blockquote>
      <blockquote>
        <table width="413">
          <tr>
            <td width="162"><b>Staff ID</b></td>
            <td width="239"> <b>:</b>  <?php echo $row_staff_details['staff_id']; ?></td>
          </tr>
          <tr>
            <td><b>Staff Name</b></td>
            <td> <b>:</b> <?php echo $row_staff_details['staff_name']; ?></td>
          </tr>
          <tr>
            <td><b>Staff Email</b></td>
            <td> <b>:</b>  <?php echo $row_staff_details['staff_email']; ?></td>
          </tr>
          <tr>
            <td><b>Staff Phone Number</b></td>
            <td> <b>:</b>  <?php echo $row_staff_details['staff_phone']; ?></td>
          </tr>
      </table>
        <blockquote>
          <p>&nbsp;</p>
...
<?php
mysql_free_result($staff_details);
?>
