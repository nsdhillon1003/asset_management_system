...
<p>    
        ...
        <h1> Item Details </h1>
        <table border="1" cellpadding="1" cellspacing="1" width="945" class=".table">
        
        
          <tr>
            <td width="110" height="29" align="center"><b>Item Id</b></td>
            <td width="130" align="center"><b>Item Name</b></td>
            <td width="150" align="center"><b>Item Type</b></td>
            <td width="190" height="29" align="center"><b>Item Description</b></td>
            <td width="130" align="center"><b>Item Status</b></td>
          ...
          <tr>
            ...
            <td><?php echo $row_item_details['item_status']; ?></td>
                       ...
                       <td><img src="<?php echo $row_item_details['image_attachment']; ?>" width="200" height="125"/></td>
          </tr>
