...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="add_room_equipment.php";
  $loginUsername = $_POST['room_id'];
  $LoginRS__query = sprintf("SELECT room_id FROM room WHERE room_id=%s", GetSQLValueString($loginUsername, "text"));
  ...
  if($loginFoundUser){
    ...
    $MM_dupKeyRedirect = $MM_dupKeyRedirect . $MM_qsChar ."room_name_duplicate=".$loginUsername;
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "add_room_list")) {
  $insertSQL = sprintf("INSERT INTO room (room_id, item_1, item_2, item_3) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "a_room_equipment_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" id="add_room_list" name="add_room_list" method="POST">
  ...
  <table width="620" class="table"><div align="left">
        ...
        <tr>
         ...
         <td width="460"><span id="sprytextfield1">
           <input type="text" name="room_id" id="room_id" />
           <span class="textfieldRequiredMsg">A Room Name is Required.</span></span></td>
        </tr>
        ...
        <tr>
          ...
          <input type="text" name="item_2" id="item_2" /></td>
        </tr>
        ...
        <tr>
            <td>ITEM NEEDED 3</td>
             ...
             <td> <label for="item_3"></label>
              <input type="text" name="item_3" id="item_3" /></td>
          </tr>
          </div>
</table>

  <p>
    <input name="submit" type="submit" class="submit" id="submit" value= "Add Room Equipment"/>
<p>
  <input type="hidden" name="MM_insert" value="add_room_list" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
