...
<div align="left" id="page">
    ...
    <blockquote>
      <blockquote>
        <form id="form1" name="form1" method="post" action="add_room_equipment.php">
          <input name="add_room_equipment" type="submit" class="submit" id="add_room_equipment" value="ADD ROOM EQUIPMENT" />
        </form>
      </blockquote>
</blockquote>
    ...
    <blockquote>
      <blockquote>
        ...
        <table width="803" border="1" cellpadding="1" cellspacing="1" class="table">
          ...
          <?php do { ?>
          <tr>
            <td><a href="update_room_equipment.php?room_id=<?php echo $row_list_equipment['room_id']; ?>" class="link"><?php echo $row_list_equipment['room_id']; ?></a></td>
