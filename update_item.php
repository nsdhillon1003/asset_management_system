...
<div align="left" id="page">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2" class="table" >
    <table width="663" align="center">
      <tr valign="baseline">
        <td width="146" align="right" nowrap="nowrap"><div align="left"><strong>Item ID</strong></div></td>
        <td width="505"><div align="left">
          <label for="item_id"></label>
          <span id="sprytextfield1">
          <input name="item_id2" type="text" id="item_id" value="<?php echo $row_update_item['item_id']; ?>" size="32" />
          <span class="textfieldRequiredMsg">An item ID is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></div></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td><span id="spryselect1">
          <select name="item_type" id="item_type" title="<?php echo $row_update_item['item_type']; ?>">
          ...
          <span class="selectInvalidMsg">Please select a valid item.</span><span class="selectRequiredMsg">Please select an item type.</span></span></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><div align="left"><strong>Item Description</strong></div></td>
        <td><div align="left"><span id="sprytextarea1">
          <textarea name="item_description" cols="32"><?php echo htmlentities($row_update_item['item_description'], ENT_COMPAT, 'utf-8'); ?></textarea>
          <span class="textareaRequiredMsg">A description is required.</span></span></div></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td><div align="left">
          <input type="file" name="image_attachment" value="<?php echo htmlentities($row_update_item['image_attachment'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
        </div></td>
      </tr>
      <tr valign="baseline">
...
<div id="footer">
	<hr />
	<p class="footer">Copyright (c) IT Asset Management System. All rights reserved.. </p>
	<hr />
	<p>&nbsp;</p>
</div>
</option>
...
var spryselect1 = new Spry.Widget.ValidationSelect("spryselect1", {isRequired:false, invalidValue:"--SELECT ITEM TYPE--"});
