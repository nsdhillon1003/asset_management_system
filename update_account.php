  ...
  <table width="676" align="left">
    <tr valign="baseline">
      ...
      <td width="526"><span id="sprytextfield6">
        <b>:</b> 
        <input type="text" name="staff_type" value="<?php echo htmlentities($row_update_user['staff_type'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td> <b>:</b> <?php echo $row_update_user['staff_id']; ?></td>
    </tr>
    <tr valign="baseline">
