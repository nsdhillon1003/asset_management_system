...
$equipment_unavailable = mysqli_query($asset_management_system,$query_equipment_unavailable) or die(mysqli_error());
$row_equipment_unavailable = mysqli_fetch_assoc($equipment_unavailable);
$totalRows_equipment_unavailable = mysqli_num_rows($equipment_unavailable);
?>
...
<?php } while($row= mysql_fetch_array($query));?>
 ...
 <table width="950" border="1" cellpadding="1" cellspacing="1" class="table" bgcolor="#CCFFCC">
   ...
   <?php do { ?>
     ...
     <?php } while ($row_equipment_unavailable = mysqli_fetch_assoc($equipment_unavailable)); ?>
 </table>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<?php
mysqli_free_result($equipment_unavailable);
?>
